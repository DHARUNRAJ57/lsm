            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="footer-about mt-40">
                        <div class="logo">
                            <a href="{{ url('/') }}"><img src="jambasangsang/frontend/images/logo.png" width="80"
                                    alt="Logo"></a>
                        </div>
                        <p>We often offer a wide range of resources, including online classes, video tutorials, interactive quizzes, and progress tracking tools to help students learn and achieve their academic goals</p>
                        <ul class="mt-20">
